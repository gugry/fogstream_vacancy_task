"""
Django settings for fogstream_vacancy_task project.
...
SECRET_KEY = '(vmzk)2ds&fc=qlfum1z1qg&h$jm(=-^siwu^55h_o%4ec=wo-'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = "mailsender1251@yandex.ru"
EMAIL_HOST_PASSWORD = "fogstream"
EMAIL_USE_SSL = True
